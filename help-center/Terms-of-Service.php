        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">
              <div class="logo-con">
                ...
                <a aria-current="page" href="#" style="color: #004AAD; font-size: 20px; margin-bottom: 5px; text-decoration: none;">Help Center</a>
              </div>
              ...
              <ul class="navbar-nav me-auto mb-5 mb-lg-0">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="../help-center/Help-Center.php">Help</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="../help-center/Privacy-Policy.php">Privacy Policy</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="../help-center/Terms-of-Service.php">Terms of Service</a>
                  </li>
                </ul>
              ...
              <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                    <a href="../help-center/Help-Center.php" style="color: #004AAD; font-size: 22px;" onclick="focusOnSearchBar()"><i class="bi bi-search"></i></a>

              </div>
              <a class="nav-link" href="../landingpage.php" style="color: #004AAD; font-size: 20px;">Home</a>
            </div>
          </nav>


          <Section id="first-section">
            <div class="privacy-logo"><h1><b>Terms of Service</b></h1></div> 
            <div class="container px-5 text-center">
                <div class="row gx-5" style="top: 10%;">
                  <div class="col-sm-11 col-md-12 col-lg-8">
                    <div class="privacy-policy-container">
                      <p><i>Effective December 15, 2023</i></p>
                      <p><i>Our Terms of Service</i></p><br>
                        <h2><b>Terms of Service</b></h2>
                        <p>TheraPeace is a web-based service that helps people find mental health resources and support groups in their area. Users can search for resources by location, Facility Service, and recommended Therapists. The system provides detailed information about each Facility resources, including contact information, hours of operation, and services offered. Users can also leave reviews and feedback about the resources they have used.</p><br>
                        <p>By using TheraPeace, you agree to the following terms of service:</p><br>
                        <p><i>You will use TheraPeace for lawful purposes only.</i></p><br>
                        <p><i>You will not use TheraPeace to post any content that is harmful, threatening, abusive, or defamatory.</i></p><br>
                        <p><i>You will not use TheraPeace to violate the privacy of others.</i></p><br>
                        <p><i>You will not use TheraPeace to infringe on the intellectual property rights of others.</i></p><br>
                        <p><i>You will not use TheraPeace to impersonate any person or entity.</i></p><br>
                        <p><i>You will not use TheraPeace to distribute viruses or other malware.</i></p><br>
                        <p>TheraPeace reserves the right to terminate your account and/or deny you access to the service at any time, for any reason.</p>
                      </div>
                    </div>
            ...
            <footer class="row row-cols-1 row-cols-sm-2 row-cols-md-4 py-1 my-3">
              ...
              <div class="col mb-3">
                ...
                <ul class="nav flex-column">
                  ...
                  <li class="nav-item mb-2"><a href="../index.php" class="nav-link p-0 text-body-secondary">COMMUNITY</a></li>
