...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 14, 2023 at 09:49 PM
...
ALTER TABLE `replies`
  ...
  ADD KEY `user_id` (`user_id`),
  ADD KEY `fk_replies_comment` (`parent_comment_id`);
...
--
ALTER TABLE `replies`
  ADD CONSTRAINT `fk_replies_comment` FOREIGN KEY (`parent_comment_id`) REFERENCES `comments` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `replies_ibfk_1` FOREIGN KEY (`post_id`) REFERENCES `posts` (`id`),
  ADD CONSTRAINT `replies_ibfk_2` FOREIGN KEY (`parent_comment_id`) REFERENCES `comments` (`id`),
