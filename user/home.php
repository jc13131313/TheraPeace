      ...
      <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
            ...
            <div class="row">
              <div class="col align-self-start">
                <div class="sectitle-container">
                  ...
                  <a href="../user/map.php" class="loc-btn"><i class="fa-solid fa-location-dot fa-2xl"></i></a>
              ...
              <div class="col align-self-end">
                <div class="explore-container">
                  <a class="explore-btn" href="../user/map.php">Explore</a>
                  <img src="../pictures/8750075.jpg" alt="">
              </div>
        ...
        <div class="col-sm-12 col-md-4">
          <div class="com-container">
            ...
            <a class="startat-btn" href="../user/forum.php">Start A Topic</a>
          </div>
        </div>
        </div>
